...
package com.chris.java.openwatch;
...
//        mInputSurface.makeEncodeContextCurrent();
    ...
    private void advanceVideoMediaMuxer(){
        MediaMuxerWrapper videoMuxer = mMuxerWrapper;//(mVideoTrackInfo.muxerWrapper == mMuxerWrapper) ? mMuxerWrapper : mMuxerWrapper2;
        MediaMuxerWrapper audioMuxer = mMuxerWrapper;//(mAudioTrackInfo.muxerWrapper == mMuxerWrapper) ? mMuxerWrapper : mMuxerWrapper2;
